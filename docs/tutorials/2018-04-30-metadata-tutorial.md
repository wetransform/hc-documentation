...
* Select the tab &laquo;Custom fields&raquo; below the description field of the organisation profile page and click &laquo;+ Add field&raquo; to add your custom key-value pair
