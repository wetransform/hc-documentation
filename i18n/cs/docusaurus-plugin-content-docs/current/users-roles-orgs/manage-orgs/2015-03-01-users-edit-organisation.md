...
Při používání funkcí rozhraní OGC API existuje možnost definovat výchozí základní mapu a odpovídající výchozí základní vrstvy pro prostorový rozsah ve službách zobrazení funkcí rozhraní OGC API. Jako výchozí základní mapa jsou podporovány pouze WMS verze 1.3.0. V poli „Výchozí základní vrstva“ můžete zadat jednu nebo více výchozích základních vrstev ve formě seznamu odděleného čárkami. Všimněte si, že pokud chcete zadat vlastní výchozí základní mapu, musíte také zadat *alespoň jednu* výchozí základní vrstvu. Pokud zadáte pouze `Výchozí základní mapu`, ale ne `Výchozí základní vrstvu`, bude použita standardní základní mapa.
