...
Die folgenden Pfade können für die Felder ```name``` und ```target``` verwendet werden. Die XPaths zu den Metadatenelementen werden hier als Referenz bereitgestellt:
